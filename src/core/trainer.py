...
def train_cultural_vector(model, train_data, axis='X', system_prompt="", batch_size=8, language=None):
    """
    ...
    for sample in train_data:
        ...
        if language is None or language == 'en':
            ...
            situation = sample['scenario_text_mlt'][language]
            low_pole = sample['options_mlt'][language][sample['mapping']['low_pole']]
            high_pole = sample['options_mlt'][language][sample['mapping']['high_pole']]
